...
def prediction():
    df = pd.read_excel("C:\\Users\\chama\\Downloads\\E-commerce_Customer_Behavior.xlsx")
...
# Load the Lottie animation file
    lottie_coding = load_lottiefile("C:\\Users\\chama\\OneDrive\\Bureau\\projetGmc\\CustomerSegmentation\\animation\\satisfaction.json")
...
# Display the Lottie animation using Streamlit
    ...
    if st.sidebar.button('Predict Satisfaction Level'):
        ...
        if prediction[0] == 'Satisfied':
            st.image(r'CustomerSegmentation\images\satisfied.jpeg', caption='High Satisfaction')
        elif prediction[0] == 'Neutral':
            st.image(r'CustomerSegmentation\images\neutral.jpeg', caption='Medium Satisfaction')
        else:
            st.image(r'CustomerSegmentation\images\unsatisfied.jpeg', caption='Low Satisfaction')
